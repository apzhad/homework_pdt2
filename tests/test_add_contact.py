...
test_data = [Contact(first_name="", last_name="")] + [
    ...
    Contact(first_name=random_string("first_name", 20), last_name=random_string("last_name", 10),
            nickname=random_string("nickname", 10), address=random_string_with_eol("address", 20),
            home_phone=random_string("homephone", 15), fax=random_string("fax", 15),
            primary_email=random_string("email", 10), birth_day=str(random.randint(1, 31)),
            birth_month=random.choice(month), birth_year=random_string("", 10),
