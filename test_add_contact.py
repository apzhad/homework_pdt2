...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        driver.find_element_by_name("photo").send_keys("C:\\fakepath\\cat.jpg")
        ...
        Select(driver.find_element_by_name("bday")).select_by_visible_text("5")
        ...
        driver.find_element_by_name("byear").send_keys("1950")
        ...
        driver.find_element_by_name("address2").send_keys("address secondary")
        driver.find_element_by_name("phone2").click()
        driver.find_element_by_name("phone2").clear()
        driver.find_element_by_name("phone2").send_keys("home secondary")
